...
# 2. JUGADORES (Cámbialos aquí)
nombres_jugadores = [“Fran“, “Pepe”, “Mauri”, “Bruno M”, “Bruno C” , “Fer”, “Fede B”, “Santi”]
avatares = {n: f"https://api.dicebear.com/7.x/avataaars/svg?seed={n}" for n in nombres_jugadores}

# 3. LÓGICA DEL FIXTURE
...
# 6. UI PRINCIPAL
st.title("🎾 Padel Pro App")

tab_pos, tab_fix, tab_admin = st.tabs(["🏆 Posiciones", "📅 Fixture", "⚙️ Ajustes"])
...
with tab_admin:
    ...
    if st.button("🚨 REINICIAR TODO EL TORNEO"):
        st.warning("¿Estás seguro? Se borrarán todos los resultados cargados.")
